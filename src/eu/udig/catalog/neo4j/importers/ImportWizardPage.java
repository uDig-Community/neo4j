...
/**
 * This is a general wizard page used by wizards that import files into Neo4j
 * Spatial databases. The page requests three things:
 * <ul>
 * <li>Database location</li>
 * <li>Spatial file to import</li>
 * <li>Layer to create in database</li>
 * </ul>
 * Some defaults are set for the user based on the selected elements in the
 * catalog when this wizard is initialized.
 * 
...
public class ImportWizardPage extends WizardPage {
	...
	private void checkFinish() {
		...
		if (isReadable(selectedFile) && selectedFile.isFile() && isReadable(neo4jDir) && neo4jDir.isDirectory()
				&& neo4jDir.canWrite()) {
